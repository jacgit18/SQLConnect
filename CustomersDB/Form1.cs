...
namespace CustomersDB
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            mycmd.CommandText = "Select * from Order_T where OrderID = @my_order_id and CustomerID like  @my_customer_id";
            ...
            //mycmd.CommandText = "Select * from Order_T where CustomerID = @my_customer_id";
            mycmd.CommandText = "Select * from Order_T where CustomerID = @my_customer_id";
            ...
            //mycmd.CommandText = "Select * from Order_T where OrderDate = @order_date";
